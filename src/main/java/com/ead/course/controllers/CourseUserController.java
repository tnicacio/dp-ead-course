...
public class CourseUserController {
    ...
    public CourseUserController(AuthUserClient courseClient, CourseService courseService, CourseUserService courseUserService) {
    ...
    public ResponseEntity<Object> saveSubscriptionUserInCourse(@PathVariable(value = "courseId") UUID courseId,
        ...
        if (responseUser.get().getUserStatus().equals(UserStatus.BLOCKED)) {
